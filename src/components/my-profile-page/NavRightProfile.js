...
const NavRightProfile = () => {
  ...
  let elements = <div>
                    <Menu fontSize="large" className="menu" onClick={handleVisible}/>
                    <a href={profile} className="menu-items chosen-item">
                      <div className="rec-orange" />
                      My profile
                    </a>
                    <a href="/favorites" className="menu-items">Favorite announcements</a>
                    <a href="/myannouncements" className="menu-items">My announcements</a>
                  </div>
  return (
  <>
    {isVisible && elements}
